...
from backend_service.image_runtime.repos import (
    ...
    _SDXL_VAE_FIX_REPO,
    _apply_scheduler,
    _gguf_transformer_class_for_repo,  # noqa: F401 — re-exported for tests
...
from backend_service.image_runtime.transformer_loaders import (
    ...
    try_load_nf4_flux_transformer,
    try_load_nunchaku_transformer,
)
...
class DiffusersTextToImageEngine:
    ...
    def _try_load_nf4_flux_transformer(
        ...
        return try_load_nf4_flux_transformer(local_path, torch)

    def _try_load_int8wo_flux_transformer(
        self, local_path: str, torch: Any,
    ) -> tuple[Any, str | None]:
        return try_load_int8wo_flux_transformer(local_path, torch)
    ...
    def _try_load_nunchaku_transformer(
        ...
        return try_load_nunchaku_transformer(repo, nunchaku_repo, nunchaku_file, torch)
    ...
    def _maybe_enable_fp8_layerwise(
        ...
        return maybe_enable_fp8_layerwise(pipeline, repo, torch)
