...
def _model_title_fragments(model: HtmlChallengeModelRequest) -> list[str]:
    fragments: list[str] = []
...
def _strip_model_names_from_title(title: str, models: list[HtmlChallengeModelRequest]) -> str:
