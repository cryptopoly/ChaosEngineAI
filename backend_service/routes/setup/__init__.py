...
# ------------------------------------------------------------------
# LongLive + Wan installer endpoints — extracted to focused submodules
# ------------------------------------------------------------------
#
# Each installer is a single-job background pattern (POST kicks off a
# daemon thread, GET polls status, frontend renders attempt rows via
