...
from backend_service.state import lifecycle as _lifecycle
...
class ChaosEngineState:
    ...
    def load_model(
        ...
        *,
        ...
        return _lifecycle.load_model(self, request, keep_warm_previous=keep_warm_previous)

    def unload_model(self, ref: str | None = None) -> dict[str, Any]:
        return _lifecycle.unload_model(self, ref)

    def convert_model(self, request: ConvertModelRequest) -> dict[str, Any]:
        return _lifecycle.convert_model(self, request)

    def reveal_model_path(self, path: str) -> dict[str, Any]:
        return _lifecycle.reveal_model_path(self, path)

    def delete_model_path(self, path: str) -> dict[str, Any]:
        return _lifecycle.delete_model_path(self, path)
