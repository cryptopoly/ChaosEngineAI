...
The suite lives at [`scripts/e2e_test_suite.py`](https://github.com/cryptopoly/ChaosEngineAI/blob/staging/scripts/e2e_test_suite.py)
and drives the [`scripts/chaosengine-cli`](https://github.com/cryptopoly/ChaosEngineAI/blob/staging/scripts/chaosengine-cli) wrapper
